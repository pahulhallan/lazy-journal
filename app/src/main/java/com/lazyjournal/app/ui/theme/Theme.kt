package com.lazyjournal.app.ui.theme
...
private val LazyJournalLightColors = lightColorScheme(
...
private val LazyJournalShapes = Shapes(
...
@Composable
fun LazyJournalTheme(content: @Composable () -> Unit) {
    MaterialTheme(
        colorScheme = LazyJournalLightColors,
        shapes = LazyJournalShapes,
        content = content
    )
}
